...
var app = (function () {
    ...
    function create_if_block_4$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 15, 4, 432);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 13, 4, 359);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_if_block_2$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 18, 4, 504);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    ...
    function create_if_block_1$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 21, 4, 597);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(21:2) {#if coins.g > 0 || coins.p > 0}",
    		ctx
    	});
    ...
    // (24:2) {#if coins.s > 0 || coins.g > 0 || coins.p > 0}
    function create_if_block$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 24, 4, 707);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(24:2) {#if coins.s > 0 || coins.g > 0 || coins.p > 0}",
    		ctx
    	});
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$c, 26, 2, 763);
    			attr_dev(span, "class", "flex justify-start text-lg items-center");
    			toggle_class(span, "text-2xl", /*large*/ ctx[0]);
    ...
    // (28:2) {#if !needRequirements(data_value, skill)}
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			attr_dev(tr, "class", "cursor-pointer");
    			add_location(tr, file$5, 28, 4, 778);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			mount_component(xpbar, tr, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(28:2) {#if !needRequirements(data_value, skill)}",
    		ctx
    	});
    ...
    // (35:6) {#each getValues(skill) as value}
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			td = element("td");
    			t = text(t_value);
    			add_location(td, file$5, 35, 8, 1036);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(35:6) {#each getValues(skill) as value}",
    		ctx
    	});
    ...
    // (27:0) {#each filtered(data_value, skills) as skill}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(27:0) {#each filtered(data_value, skills) as skill}",
    		ctx
    	});
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<SkillBars> was created with unknown prop '${key}'`);
    	});
    ...
    // (72:10) {#if data_value.day > 365 * 50}
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 72, 12, 2711);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(72:10) {#if data_value.day > 365 * 50}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(88:8) {#if selectedTab == \\\"skills\\\"}",
    		ctx
    	});
