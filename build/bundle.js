...
var app = (function () {
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			attr_dev(tr, "class", "cursor-pointer");
    			add_location(tr, file$5, 27, 4, 767);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			mount_component(xpbar, tr, null);
    ...
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			td = element("td");
    			t = text(t_value);
    			add_location(td, file$5, 34, 8, 1025);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, t);
    ...
    // (63:10) {#if data_value.day > 365 * 50}
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 63, 12, 2463);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(63:10) {#if data_value.day > 365 * 50}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(79:8) {#if selectedTab == \\\"skills\\\"}",
    		ctx
    	});
